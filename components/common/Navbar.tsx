    ...
    >
      <div
        className={`w-full flex justify-between items-center max-w-[1280px] px-[7%] xl:px-0 ${
          font === "Fa" || font === "Ar" ? "my-4" : "my-5"
        } `}
      >
        <Link className="flex items-center gap-x-2" href="/">
          {font === "Fa" || font === "Ar" ? (
            <Image src={LogoFa} className="w-fit sm:h-16 h-[3rem]" alt="Logo" />
          ) : (
            <>
              <Image
                src={Logo}
              ...
              <div
                className={`flex flex-col ${
                  font === "Fa" || font === "Ar" ? "gap-y-0.5" : "-mb-1"
                } `}
              >
                <span
        ...
        <div className="flex items-center gap-4 lg:hidden">
          ...
          <button
            className={`p-3 bg-${theme} rounded-full`}
