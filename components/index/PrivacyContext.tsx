    ...
    <section className="w-full h-full flex justify-between items-center ">
      <div className="w-full h-full flex flex-col relative gap-y-10 sm:gap-y-28 mb-10 lg:mb-0 ">
        ...
        <div className=" bg-dark p-5 rounded-2xl w-full h-full grid grid-cols-12 grid-rows-4 bg-transparent gap-y-5 z-[1] gap-x-5">
              ...
              <div
                className={
                  expandContext.title === "Why"
                    ...
                    : "text-gray text-center text-lg w-full rounded-2xl p-5 bg-dark-back transition-all duration-500 h-fit"
                }
              >
                <button
                ...
                <div className="w-full h-full flex justify-center">
                  <div
                    className={
                      expandContext.title === "Why"
                        ? `bg-dark flex  w-full h-fit justify-center items-start flex-col text-light transition-all duration-300 rounded-2xl p-4 gap-y-3`
                        : `hidden`
                    }
                  >
                    <button
          ...
          <div className="row-span-3 col-span-12 md:row-span-4 md:col-span-8 bg-dark-glass text-light p-5 rounded-2xl text-xl text-start">
            {context}
          </div>
        </div>
      </div>
